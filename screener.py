...
def get_historical_data_yf(symbol, interval="1h"):
    """ ดึงข้อมูลกราฟย้อนหลังจาก Yahoo Finance สากล """
    try:
...
def screen_crypto():
    ...
    for symbol in WATCHLIST:
        # แปลงชื่อสำหรับแสดงผลให้เข้าใจง่าย เช่น BTC_THB
        ...
        # คำนวณอินดิเคเตอร์เทคนิคัลจากกราฟสากล
        ...
        # คูณอัตราแลกเปลี่ยนแปลงเป็นบาทหน้างาน
